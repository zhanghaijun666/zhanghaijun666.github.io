import{_ as r}from"./plugin-vue_export-helper-c27b6911.js";import{r as d,o as c,c as u,e as t,a as i,d as e,w as l,b as n,f as a}from"./app-efa5e96e.js";const o={},m={class:"table-of-contents"},b=a(`<h2 id="基础模块" tabindex="-1"><a class="header-anchor" href="#基础模块" aria-hidden="true">#</a> 基础模块</h2><h3 id="http-access-白名单" tabindex="-1"><a class="header-anchor" href="#http-access-白名单" aria-hidden="true">#</a> HTTP Access（白名单）</h3><blockquote><p>此模块提供了一个简易的基于主机的访问控制.</p></blockquote><div class="language-conf line-numbers-mode" data-ext="conf"><pre class="language-conf"><code>## 仅允许网段 192.168.1.0/24中除 192.168.1.1之外的ip访问.
location / {
  deny    192.168.1.1;
