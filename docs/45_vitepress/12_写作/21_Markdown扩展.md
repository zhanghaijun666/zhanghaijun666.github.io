...
```md
<<< @/45_vitepress/snippets/snippet.js{2}
```

**Code file**

<<< @/45_vitepress/snippets/snippet.js
...
```md
<<< @/45_vitepress/snippets/snippet-with-region.js#snippet{1}
```

**Code file**

<<< @/45_vitepress/snippets/snippet-with-region.js
...
```md
<<< @/45_vitepress/snippets/snippet.cs{c#}

<!-- 带行高亮: -->

<<< @/45_vitepress/snippets/snippet.cs{1,2,4-6 c#}

<!-- 带行号: -->

<<< @/45_vitepress/snippets/snippet.cs{1,2,4-6 c#:line-numbers}
```
...
<<< @/45_vitepress/snippets/snippet-with-region.js#snippet{1,2 ts:line-numbers} [snippet with region]
