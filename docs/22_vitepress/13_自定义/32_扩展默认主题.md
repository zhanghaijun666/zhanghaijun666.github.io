...
:::tip
在继续之前，请确保首先阅读[自定义主题](https://vitepress.dev/zh/custom-theme)以了解其工作原理。
:::
...
:root {
  --vp-font-family-base: /* normal text font */ --vp-font-family-mono: /* code font */;
}
```
...
![Appearance Toggle Transition Demo](/vitepress.webp)
