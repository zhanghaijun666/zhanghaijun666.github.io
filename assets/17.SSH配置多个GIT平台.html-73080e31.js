import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{o as a,c as s,f as n}from"./app-d6438571.js";const i={},l=n(`<h2 id="_1、git全局配置" tabindex="-1"><a class="header-anchor" href="#_1、git全局配置" aria-hidden="true">#</a> 1、Git全局配置</h2><p>如果之前设置过全局的<code>user.name</code>和<code>user.email</code>, 需要先删掉，删除命令如下</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 查看全局配置</span>
