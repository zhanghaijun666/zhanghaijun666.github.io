import{_ as o}from"./plugin-vue_export-helper-c27b6911.js";import{r as l,o as d,c as r,e as p,a as n,d as e,w as i,b as s,f as c}from"./app-d6438571.js";const m={},v={class:"table-of-contents"},u=c(`<h2 id="环境准备" tabindex="-1"><a class="header-anchor" href="#环境准备" aria-hidden="true">#</a> 环境准备</h2><ul><li>节点 CPU 核数必须是 ：&gt;= 2 核 ，否则 k8s 无法启动</li><li>DNS 网络： 最好设置为 本地网络连通的 DNS,否则网络不通，无法下载一些镜像</li><li>linux 内核： linux 内核必须是 4 版本以上，因此必须把 linux 核心进行升级</li></ul><blockquote><p>准备 3 台虚拟机环境，或者是 3 台阿里云服务器都可。</p></blockquote><ul><li>k8s-master01: 此机器用来安装 k8s-master 的操作环境</li><li>k8s-node01: 此机器用来安装 k8s node 节点的环境</li><li>k8s-node02: 此机器用来安装 k8s node 节点的环境</li></ul><h2 id="依赖环境" tabindex="-1"><a class="header-anchor" href="#依赖环境" aria-hidden="true">#</a> 依赖环境</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 安装依赖环境，注意：每一台机器都需要安装此依赖环境</span>
