import{_ as t}from"./plugin-vue_export-helper-c27b6911.js";import{r as l,o as c,c as o,a as e,d as n,w as i,b as s,f as d}from"./app-d6438571.js";const u={},v={class:"table-of-contents"},m=d(`<h2 id="仓库部署" tabindex="-1"><a class="header-anchor" href="#仓库部署" aria-hidden="true">#</a> 仓库部署</h2><h3 id="_1、docker部署" tabindex="-1"><a class="header-anchor" href="#_1、docker部署" aria-hidden="true">#</a> 1、Docker部署</h3><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">docker</span> run <span class="token parameter variable">-d</span> <span class="token parameter variable">-p</span> <span class="token number">5000</span>:5000 <span class="token parameter variable">--restart</span> always <span class="token parameter variable">--name</span> registry registry
