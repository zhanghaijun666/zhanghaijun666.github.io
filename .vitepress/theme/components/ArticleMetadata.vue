...
const { page } = useData()
const date = computed(() => new Date(page.value.lastUpdated || new Date()))
...
<template>
  <div class="word">
    <div class="flex-x-start gap-3">
      <!-- 更新时间 -->
      <div class=":uno: flex-x-start gap-1">
      ...
      <div class=":uno: flex-x-start gap-1">
        <svg class="icon" viewBox="0 0 1024 1024" width="16" height="16">
          <path
            ...
            fill="#777777"
          ></path>
          <path d="M682.666667 0l273.066666 273.066667h-204.8c-40.96 0-68.266667-27.306667-68.266666-68.266667V0z" fill="#E0E0E0" opacity=".619"></path>
        </svg>
        <div>字数: {{ wordCount }} 字</div>
      </div>
      <!-- 文章时长 -->
      <div class=":uno: flex-x-start gap-1">
