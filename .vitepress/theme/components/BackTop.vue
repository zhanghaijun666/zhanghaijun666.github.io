<template>
  <Transition name="fade">
    <div v-show="showBackTop" class="vitepress-backTop-main" title="返回顶部" @click="scrollToTop()">
      <svg class="icon" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" p-id="4279" width="200" height="200">
        <path
...
// 节流
const throttle = <T extends (...args: any[]) => void>(fn: T, delay: number = 100): (...args: Parameters<T>) => void => {
  let lastTime = 0
